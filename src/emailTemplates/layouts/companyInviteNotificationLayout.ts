...
export const companyInviteNotificationLayout = ({ body }: { body: string }) => `
  <mjml>
    <mj-head>
      <mj-attributes>
        ...
        <mj-section>
          <mj-column width="100%">
            <mj-image
              align="left"
              padding="10px 0px"
              src="https://abcd.example.com/xyz-logo.svg"
              width="360px">
            </mj-image>
          </mj-column>
        </mj-section>
        <mj-section background-color="${White}" padding="0 48px 36px 48px">
          <mj-column width="100%">
            ${body}
          </mj-column>
        </mj-section>
